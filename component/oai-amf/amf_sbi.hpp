...
class amf_sbi {
 public:
  ...
  // ---------------------- Orchra -------------------------------
  // Handler for incoming migration REST requests via HTTP server
    void handle_migration_restore_request(const nlohmann::json& request_body, nlohmann::json& response_body, int& http_code);
  // ------------------------------ end of Orchra ----------------
};
