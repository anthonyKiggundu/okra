...
// Forward declarations to remove compilation dependencies
namespace oai {
  namespace app {
    namespace smf {
      class smf_context;
...
struct OrchraUeContextSnapshot {
  ...
  // Seamless Security Sync Tracking Data
  ...
  std::string kseaf;         // SEAF Key (Hex string)
